...
requirements = python3,kivy,pillow,kivymd==1.0.1,mutagen,ffpyplayer,nltk,regex,plyer
...
# (list) Permissions
android.permissions = INTERNET,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,READ_PHONE_STATE
